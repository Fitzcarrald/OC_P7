...
L’entreprise souhaite développer un modèle de « scoring » pour calculer la probabilité de défaut de paiement pour étayer la décision d'accorder ou non un prêt à un client potentiel en s’appuyant sur des sources de données variées (données comportementales, données provenant d'autres institutions financières, etc.).
...
Les données dont vous aurez besoin pour réaliser le dashboard vous pouvez les télécharger à cette adresse :
